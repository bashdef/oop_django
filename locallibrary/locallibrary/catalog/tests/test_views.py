...
class AuthorCreateTest(TestCase):
    ...
    def test_form_date_of_death_initially_set_to_expected_date(self):
        ...
        self.assertEqual(resp_date, expected_initial_date)
    ...
    def test_redirects_to_detail_view_on_succes(self):
        login = self.client.login(username='testuser2', password='12345')
        resp = self.client.post(reverse('author-create'), {'first_name': 'name', 'last_name': 'surname'})
